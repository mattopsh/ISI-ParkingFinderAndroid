...
class FavoriteAdapter(val parkingData: ArrayList<ParkingByLocationDto> = arrayListOf()) : RecyclerView.Adapter<FavoriteAdapter.ParkingVH>() {
    ...
    inner class ParkingVH(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(position: Int) {
            ...
            view.setOnClickListener {
                view.context.startActivity(view.context.intentFor<ParkingDetailsActivity>().putExtra(ParkingDetailsActivity.PARKING_BY_LOCATION, parking))
            }
        }
    }
}